...
public class Control implements ActionListener {
	...
	public void restart() {
		...
		view.restart(field1, field2, field3, field4, field5, field6, field7,
	...
	public void change_air_molar_mass(double air_molar_mass) {
		...
		this.view.change_air_molar_mass(format(air_molar_mass), field3,
				execution);
	}
	...
	public void change_air_temperature(double air_temperature) {
		...
		this.view.change_air_temperature(format(air_temperature), field3,
				execution);
	}
